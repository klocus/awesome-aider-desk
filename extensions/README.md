...
npx @aiderdesk/extensions install https://github.com/klocus/awesome-aider-desk/tree/master/extensions/path-instructions --global

# Install from this repository - Local (project-specific)
npx @aiderdesk/extensions install https://github.com/klocus/awesome-aider-desk/tree/master/extensions/path-instructions
```
...
3. Add this repository URL to the extension catalogs:
   ```
   https://github.com/klocus/awesome-aider-desk/tree/master/extensions
   ```
